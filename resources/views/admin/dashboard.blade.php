...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white"><h6 class="mb-0">Recent Reservations</h6></div>
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge bg-{{ $r->status === 'checked_in' ? 'success' : ($r->status === 'pending' ? 'warning' : 'secondary') }}">{{ $r->status }}</span></td>
                </tr>
                @empty
